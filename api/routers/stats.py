...
async def get_dashboard(
    ...
    calculated_hi = hcap.handicap_index(rounds_chrono, seed_handicap=user.handicap)
...
async def get_analytics(
    ...
    current_hi = hcap.handicap_index(rounds, seed_handicap=user.handicap)
    ...
    return {
        ...
        "handicap_trend": hcap.handicap_trend(rounds, seed_handicap=user.handicap),
